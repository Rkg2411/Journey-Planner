...
public class CheckHotels extends JFrame implements Runnable{
    ...
    public void run()
    {
        String[]text=new String[]{"JW Marriot Hotel","Madarin Oriental Hotel","Raddison Blue Hotel","Classic Hotel","The Bay Club Hotell","Breeze Blow Hotel","Taj Hotel","Happy Morning Hotel","River view Hotel","Snow Point Hotel"};
        try{
           for(int i=0;i<=9;i++)
           {
